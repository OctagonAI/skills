...
For detailed setup instructions including Claude Desktop and Windsurf, see the [mcp-setup.md](financial-metrics-analysis/references/mcp-setup.md) reference in any skill folder.
